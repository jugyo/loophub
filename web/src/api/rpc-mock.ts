  ...
  return vi.fn(async (_input: RequestInfo | URL, init?: RequestInit) => {
    ...
    try {
      ...
      if (e instanceof RpcFault) {
        return send({ jsonrpc: "2.0", id: 1, error: { code: -32000, message: e.message, data: { status: e.status } } });
      }
      throw e;
    }
  });
...
export function rpcCall(method: string): { method: string; params: any } | undefined {
