...
function usageTotal(usage: SessionUsage[] | undefined): SessionUsage {
...
function usageCost(usage: SessionUsage[] | undefined): number | null {
...
function modelLabel(usage: SessionUsage[] | undefined): string {
