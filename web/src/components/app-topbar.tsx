...
function TopbarAgentCosts() {
  ...
  return (
    <div
      className="hidden max-w-[34rem] shrink min-w-0 items-center gap-2 rounded-md border bg-background/70 px-2 py-1 text-[11px] leading-tight text-muted-foreground md:flex"
