...
// lh-web surface proxied to the server: JSON-RPC and binary attachment routes.
const API_PATHS = ["/rpc", "/attachments"];
...
// referenced from both to avoid 404s on API calls.
