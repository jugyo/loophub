...
//
// Unlike the old skill, the GitHub title/body are written in the language used by the target PR /
// change rather than fixed to English (#1892): a Japanese change gets a Japanese PR.
function render(
