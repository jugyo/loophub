...
export function usage(): void {
  ...
  lh workflow start <owner>/<repo>/<issue> | <issue> [--repo owner/name] (--workflow <name> | --workflow-id <id>) [--herdr] [--auto] [--model <name>] [--no-launch]   # start a Workflow run (--auto: launch the parent and all step agents in auto mode)
