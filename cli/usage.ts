...
export function usage(): void {
  ...
  lh workflow next <run> [--repo owner/name] [--event <id> [--requires-changes true|false] | --note <text|->] [--json]      # advise the parent's next action, including an optional external input, without changing run state
