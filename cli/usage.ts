...
export function usage(): void {
  ...
  lh session register --id <uuid> --agent <kind> --session <runtime-id> [--name "..."] [--runtime claude-code|codex|grok|opencode|opencode2] [--model <name>] [--kind dev|review|issue-create]
  lh session list
